...
use SL\PlateformBundle\Entity\Image;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SLPlateformBundle:Image')->findAll();
     ...
     * @Method("POST")
     * @Template("SLPlateformBundle:Image:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SLPlateformBundle:Image')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SLPlateformBundle:Image:edit.html.twig")
     */
