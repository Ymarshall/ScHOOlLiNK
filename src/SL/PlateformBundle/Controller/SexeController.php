...
use SL\PlateformBundle\Entity\Sexe;
use SL\PlateformBundle\Form\SexeType;
...
class SexeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SLPlateformBundle:Sexe')->findAll();
     ...
     * @Method("POST")
     * @Template("SLPlateformBundle:Sexe:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SLPlateformBundle:Sexe')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SLPlateformBundle:Sexe:edit.html.twig")
     */
