...
use SL\PlateformBundle\Entity\Matiere;
use SL\PlateformBundle\Form\MatiereType;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SLPlateformBundle:Matiere')->findAll();
     ...
     * @Method("POST")
     * @Template("SLPlateformBundle:Matiere:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SLPlateformBundle:Matiere')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SLPlateformBundle:Matiere:edit.html.twig")
     */
