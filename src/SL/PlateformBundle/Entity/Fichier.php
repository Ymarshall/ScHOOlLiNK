 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="SL\PlateformBundle\Entity\FichierRepository")
 ...
 *          "application/x-pdf"
 *      },
 *    mimeTypesMessage = "Fichier au format PDF est obligatoire",
     * maxSizeMessage = "Fichier trop lourd,La taille maximum est de 5M.")
     */
    private $file;
  ...
  public function upload()
  {
    ...
    $this->file->move(
      ...
      $this->nom   // Le nom du fichier à créer, ici « id.extension »
    );
  }
